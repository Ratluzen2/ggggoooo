        ...
        {step === 'method' ? (
           <div className="p-6 space-y-6 flex flex-col h-full">
              ...
              <div className="space-y-3 flex-1">
                 ...
                 <button 
                   onClick={() => {
                       if (userBalance >= price) setSelectedMethod('wallet');
                   }}
                   ...
                   } ${userBalance < price ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer'}`}
                 >
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div className="text-right">
                            ...
                            <div className="flex gap-1 mt-1 opacity-80">
                                <span className="text-[10px] bg-white text-blue-800 px-1 rounded font-bold italic">VISA</span>
                                <span className="text-[10px] bg-white text-red-600 px-1 rounded font-bold italic">Master</span>
                            </div>
                        </div>
                    </div>
           ...
           <div className="p-6 overflow-y-auto max-h-[70vh]">
               <div className="flex items-center gap-2 mb-6 cursor-pointer text-gray-400 hover:text-white" onClick={() => setStep('method')}>
                  <ArrowLeft size={18} />
                  <span className="text-sm font-bold">تغيير الطريقة</span>
               </div>

               <h3 className="text-center font-bold text-white mb-6">الدفع عبر البطاقة</h3>
